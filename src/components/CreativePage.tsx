    ...
    <div className="relative flex min-h-screen w-full flex-col overflow-hidden bg-slate-950 p-8 text-white md:p-16">
      ...
      <div className="flex flex-1 flex-col items-center justify-center">
        <div className="flex max-w-4xl flex-col items-center gap-12 text-center">
          <h2 className="font-bowlby bg-linear-to-br from-cyan-400 via-purple-600 to-blue-500 bg-clip-text text-center text-7xl leading-none text-transparent opacity-80 md:text-[12rem]">
            TOTAL <br /> CHAOS
          </h2>
          <img
            src="/cutter.png"
